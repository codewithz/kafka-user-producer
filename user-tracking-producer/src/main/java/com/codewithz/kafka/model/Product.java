...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7029952441544233599L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.codewithz.kafka.model\",\"fields\":[{\"name\":\"Color\",\"type\":{\"type\":\"enum\",\"name\":\"Color\",\"symbols\":[\"GREEN\",\"BLUE\",\"PURPLE\"]}},{\"name\":\"ProductType\",\"type\":{\"type\":\"enum\",\"name\":\"ProductType\",\"symbols\":[\"TSHIRT\",\"DESIGN\"]}},{\"name\":\"DesignType\",\"type\":{\"type\":\"enum\",\"name\":\"DesignType\",\"symbols\":[\"NONE\",\"SUITCASE\",\"CAR\",\"WARNING\"]}}]}");
  ...
  private com.codewithz.kafka.model.Color Color;
  private com.codewithz.kafka.model.ProductType ProductType;
  private com.codewithz.kafka.model.DesignType DesignType;
   ...
   */
  public Product(com.codewithz.kafka.model.Color Color, com.codewithz.kafka.model.ProductType ProductType, com.codewithz.kafka.model.DesignType DesignType) {
    this.Color = Color;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: Color = (com.codewithz.kafka.model.Color)value$; break;
    case 1: ProductType = (com.codewithz.kafka.model.ProductType)value$; break;
    case 2: DesignType = (com.codewithz.kafka.model.DesignType)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.codewithz.kafka.model.Color getColor() {
    return Color;
  }
   ...
   */
  public void setColor(com.codewithz.kafka.model.Color value) {
    this.Color = value;
  }
   ...
   */
  public com.codewithz.kafka.model.ProductType getProductType() {
    return ProductType;
  }
   ...
   * @param value the value to set.
   */
  public void setProductType(com.codewithz.kafka.model.ProductType value) {
   ...
   */
  public com.codewithz.kafka.model.DesignType getDesignType() {
    return DesignType;
  }
   ...
   * @param value the value to set.
   */
  public void setDesignType(com.codewithz.kafka.model.DesignType value) {
   ...
   */
  public static com.codewithz.kafka.model.Product.Builder newBuilder() {
    return new com.codewithz.kafka.model.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.codewithz.kafka.model.Product.Builder newBuilder(com.codewithz.kafka.model.Product.Builder other) {
    if (other == null) {
      return new com.codewithz.kafka.model.Product.Builder();
    } else {
      return new com.codewithz.kafka.model.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.codewithz.kafka.model.Product.Builder newBuilder(com.codewithz.kafka.model.Product other) {
    if (other == null) {
      return new com.codewithz.kafka.model.Product.Builder();
    } else {
      return new com.codewithz.kafka.model.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.codewithz.kafka.model.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.codewithz.kafka.model.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.Color)) {
        this.Color = data().deepCopy(fields()[0].schema(), other.Color);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codewithz.kafka.model.Product.Builder setColor(com.codewithz.kafka.model.Color value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codewithz.kafka.model.Product.Builder clearColor() {
      Color = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codewithz.kafka.model.Product.Builder setProductType(com.codewithz.kafka.model.ProductType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codewithz.kafka.model.Product.Builder clearProductType() {
      ProductType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codewithz.kafka.model.Product.Builder setDesignType(com.codewithz.kafka.model.DesignType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.codewithz.kafka.model.Product.Builder clearDesignType() {
      DesignType = null;
    ...
    public Product build() {
      try {
        ...
        record.Color = fieldSetFlags()[0] ? this.Color : (com.codewithz.kafka.model.Color) defaultValue(fields()[0]);
        record.ProductType = fieldSetFlags()[1] ? this.ProductType : (com.codewithz.kafka.model.ProductType) defaultValue(fields()[1]);
        record.DesignType = fieldSetFlags()[2] ? this.DesignType : (com.codewithz.kafka.model.DesignType) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.Color = com.codewithz.kafka.model.Color.values()[in.readEnum()];

      this.ProductType = com.codewithz.kafka.model.ProductType.values()[in.readEnum()];

      this.DesignType = com.codewithz.kafka.model.DesignType.values()[in.readEnum()];
